...
- Tier inference: a manufacturer found under "## Tier 1 — …" → tier 1; "## Tier 2 — …" → tier 2; "## Tier 3 — …" → tier 3. If no Tier section header is visible in the chunk, infer from prominence: well-known global brand = 1, specialty/regional = 2, legacy/regional small = 3.
